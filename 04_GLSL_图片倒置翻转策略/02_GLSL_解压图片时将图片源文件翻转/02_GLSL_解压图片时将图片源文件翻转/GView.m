...
- (void)renderLayer
{
    ...
    GLfloat attrArr[] =
    {
        ...
        -0.5f, -0.3f, -1.0f,    0.0f, 0.0f, //左下
        
        0.5f, 0.3f, -1.0f,      1.0f, 1.0f, //右上
        -0.5f, 0.3f, -1.0f,     0.0f, 1.0f, //左上
        0.5f, -0.3f, -1.0f,     1.0f, 0.0f, //右下
    };
...
//    CGContextDrawImage(spriteContext, rect, spriteImage);
    ...
    // ------解决纹理倒置------
    //CGContextTranslateCTM:平移变换根据我们指定的x,y轴的值移动坐标系统的原点。 我们通过调用CGContextTranslateCTM函数来修改每个点的x, y坐标值
    //例rect (origin = (x = 0, y = 0), size = (width = 400, height = 400))
    //图片沿x轴移动0个单位，沿y轴移动0个单位
    CGContextTranslateCTM(spriteContext, rect.origin.x, rect.origin.y);
    //图片沿y轴移动 rect.size.height 个单位  这里是400
